  ...
  return (
    <>
      <button
        ...
        className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full bg-zinc-300/10 dark:hover:bg-zinc-700/50 transition-all"
      >
        <SearchIcon className="w-4 h-4 text-zinc-400 dark:text-zinc-400" />
        <p className="font-semibold text-sm text-zinc-400 dark:text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-all">
          Search
        </p>
        <KeyBoardKey
          symbol="K"
