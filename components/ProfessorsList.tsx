...
const ProfessorsList = async () => {
  ...
  return (
    <div className="absolute top-[68px] w-[250px] md:block hidden right-0 bg-white/10 backdrop-blur-md p-5 rounded-xl h-fit overflow-y-auto">
      <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-indigo-500 to-purple-500 -z-10 transform scale-[0.40] bg-red-500 rounded-full blur-[250px]" />
