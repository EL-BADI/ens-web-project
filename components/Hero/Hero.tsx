...
const Hero = () => {
  return (
    <div className="relative h-screen flex flex-col items-center justify-center">
      <div className="absolute -z-10 top-0 left-1/2 -translate-x-2/4 h-full md:w-2/3 w-full bg-gradient-to-r from-indigo-500 to-purple-500 transform scale-[0.35] bg-red-500 rounded-full md:blur-[700px] blur-[400px]" />
