...
function Hero() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 mt-20 h-screen md:h-auto bg-black relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        <div className="absolute w-full md:-bottom-20 bottom-20 h-72 md:h-full z-10">
...
//       >
//         <h2 className="md:text-7xl text-4xl heroTitle font-extrabold text-center">
//           Ens-Kouba AI Home
//         </h2>
